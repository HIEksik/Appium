...
public class Driver {
    ...
    public static AndroidDriver getAndroidDriver()  {
        ...
        if (appiumDriver == null) {
            ...
            caps.setCapability(MobileCapabilityType.NO_RESET,false);// eger bu capability FALSE olarak kullanilirsa,uygulama test edildikten sonra her seferinde kullanici datalari temizlenir ve
            //uygulamanin ilk install haline dondurulur

            // eger true olursa kullanicili bilgileri test bittikten sonra sifirlanmaz ve tercihler kaydedilir.Islemlere kaldiginiz yerden devam edilir/ çerezleri silmez sıfırlanmaz
